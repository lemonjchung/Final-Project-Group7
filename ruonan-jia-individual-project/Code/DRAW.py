...
if __name__ == '__main__':
    ...
    ############################
    # conv layers
    size_list = [128, 127, 64, 63, 32, 31, 16, 15, 8, 7, 5, 4, 2]
    ...
    text_list = ['Convolution', 'Max-pooling', 'Convolution', 'Max-pooling', 'Convolution', 'Max-pooling', 'Convolution', 'Max-pooling','Convolution', 'Max-pooling', 'Convolution', 'Max-pooling']
